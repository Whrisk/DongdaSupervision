...
object HTTP {
    def apply(url : String) : HttpService = new HttpService(url)
}

case class HttpService(val url : String) {
    ...
    /**
      * set request headers
      */
    def header(parameters : (String, String)*) : HttpService = {
